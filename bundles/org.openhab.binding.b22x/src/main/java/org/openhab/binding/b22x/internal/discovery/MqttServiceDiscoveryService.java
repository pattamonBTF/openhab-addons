 ...
 */
package org.openhab.binding.b22x.internal.discovery;
...
public class MqttServiceDiscoveryService extends AbstractDiscoveryService implements MqttServiceObserver {
    ...
    public MqttServiceDiscoveryService() {
        //super(Stream.of(B22XBindingConstants.BRIDGE_TYPE_SYSTEMBROKER, B22XBindingConstants.BRIDGE_TYPE_BROKER)
        super(Stream.of(B22XBindingConstants.BRIDGE_TYPE_BROKER)
    ...
    public void brokerAdded(String brokerId, MqttBrokerConnection broker) {
        ...
        ThingUID thingUID;
        //thingUID = new ThingUID(B22XBindingConstants.BRIDGE_TYPE_SYSTEMBROKER, brokerId);
        thingUID = new ThingUID(B22XBindingConstants.BRIDGE_TYPE_BROKER, brokerId);
