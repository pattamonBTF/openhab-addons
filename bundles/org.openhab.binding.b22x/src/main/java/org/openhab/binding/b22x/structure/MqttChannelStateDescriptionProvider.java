...
import org.openhab.binding.b22x.structure.internal.B22XStructureHandlerFactory;
...
/**
 * If the user configures a BWC channel and defines for example minimum/maximum/readonly,
 * we need to dynamically override the xml default state.
 * This service is started on-demand only, as soon as {@link B22XStructureHandlerFactory} requires it.
 *
 * It is filled with new state descriptions within the {@link B22XStructureHandler}.
 *
 * @author David Graeff - Initial contribution, Pattamon Viriyothai - editor
 */
