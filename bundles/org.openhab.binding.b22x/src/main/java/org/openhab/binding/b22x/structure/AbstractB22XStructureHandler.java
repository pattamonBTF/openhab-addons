 ...
 */
package org.openhab.binding.b22x.structure;
...
import org.openhab.binding.b22x.structure.values.OnOffValue;
import org.openhab.binding.b22x.structure.values.Value;
import org.openhab.binding.b22x.handler.AbstractBrokerHandler;
 ...
 * because of a lost connection ({@link AbstractB22XStructureHandler#stop()}).
 *
 * <p>
 ...
 */
@NonNullByDefault
public abstract class AbstractB22XStructureHandler extends BaseThingHandler
        implements ChannelStateUpdateListener, AvailabilityTracker {
    private final Logger logger = LoggerFactory.getLogger(AbstractB22XStructureHandler.class);
    ...
    public AbstractB22XStructureHandler(Thing thing, int subscribeTimeout) {
        super(thing);
