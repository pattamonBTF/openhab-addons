...
import org.openhab.binding.b22x.discovery.MQTTTopicDiscoveryParticipant;
import org.openhab.binding.b22x.discovery.MQTTTopicDiscoveryService;
import org.openhab.binding.b22x.handler.AbstractBrokerHandler;
import org.openhab.binding.b22x.handler.BrokerHandler;
...
public class MqttBrokerHandlerFactory extends BaseThingHandlerFactory implements MQTTTopicDiscoveryService {
    private static final Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Stream
            //.of(B22XBindingConstants.BRIDGE_TYPE_SYSTEMBROKER, B22XBindingConstants.BRIDGE_TYPE_BROKER)
            .of(B22XBindingConstants.BRIDGE_TYPE_BROKER)
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        //if (thingTypeUID.equals(B22XBindingConstants.BRIDGE_TYPE_SYSTEMBROKER)) {
            //handler = new SystemBrokerHandler((Bridge) thing, mqttService);
        if (thingTypeUID.equals(B22XBindingConstants.BRIDGE_TYPE_BROKER)) {
